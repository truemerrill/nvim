...
local function lsp_keymaps(buffer)
  ...
  vim.api.nvim_buf_set_keymap(buffer, "n", "[d", '<cmd>lua vim.diagnostic.goto_prev({ border = "rounded" })<CR>', opts)
  ...
  vim.api.nvim_buf_set_keymap(buffer, "n", "]d", '<cmd>lua vim.diagnostic.goto_next({ border = "rounded" })<CR>', opts)
